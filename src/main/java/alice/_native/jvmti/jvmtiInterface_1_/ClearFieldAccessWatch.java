...
public final class ClearFieldAccessWatch {
    ...
    private static final long code_base = JVMTINativeCall.create(ClearFieldAccessWatch.class, "()I", JVMTINativeCall.CLEAR_FIELD_ACCESS_WATCH, new int[]{JVMTINativeCall.INTEGER, JVMTINativeCall.INTEGER});
