...
public final class ClearFieldModificationWatch {
    ...
    private static final long code_base = JVMTINativeCall.create(ClearFieldModificationWatch.class, "()I", JVMTINativeCall.CLEAR_FIELD_MODIFICATION_WATCH, new int[]{JVMTINativeCall.INTEGER, JVMTINativeCall.INTEGER});
