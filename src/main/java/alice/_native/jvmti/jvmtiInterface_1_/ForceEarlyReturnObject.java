...
public final class ForceEarlyReturnObject {
    ...
    private static final long code_base = JVMTINativeCall.create(ForceEarlyReturnObject.class, "()I", JVMTINativeCall.FORCE_EARLY_RETURN_OBJECT, new int[]{JVMTINativeCall.INTEGER, JVMTINativeCall.INTEGER});
