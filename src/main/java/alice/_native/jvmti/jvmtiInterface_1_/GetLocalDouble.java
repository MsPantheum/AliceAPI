...
public final class GetLocalDouble {
    ...
    private static final long code_base = JVMTINativeCall.create(GetLocalDouble.class, "()I", JVMTINativeCall.GET_LOCAL_DOUBLE, new int[]{JVMTINativeCall.INTEGER, JVMTINativeCall.INTEGER, JVMTINativeCall.INTEGER, JVMTINativeCall.INTEGER});
