...
public final class GetLocalInt {
    ...
    private static final long code_base = JVMTINativeCall.create(GetLocalInt.class, "()I", JVMTINativeCall.GET_LOCAL_INT, new int[]{JVMTINativeCall.INTEGER, JVMTINativeCall.INTEGER, JVMTINativeCall.INTEGER, JVMTINativeCall.INTEGER});
