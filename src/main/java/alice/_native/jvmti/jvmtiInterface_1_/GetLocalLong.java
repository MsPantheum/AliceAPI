...
public final class GetLocalLong {
    ...
    private static final long code_base = JVMTINativeCall.create(GetLocalLong.class, "()I", JVMTINativeCall.GET_LOCAL_LONG, new int[]{JVMTINativeCall.INTEGER, JVMTINativeCall.INTEGER, JVMTINativeCall.INTEGER, JVMTINativeCall.INTEGER});
