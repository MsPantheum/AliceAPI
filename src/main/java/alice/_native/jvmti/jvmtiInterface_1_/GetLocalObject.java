...
public final class GetLocalObject {
    ...
    private static final long code_base = JVMTINativeCall.create(GetLocalObject.class, "()I", JVMTINativeCall.GET_LOCAL_OBJECT, new int[]{JVMTINativeCall.INTEGER, JVMTINativeCall.INTEGER, JVMTINativeCall.INTEGER, JVMTINativeCall.INTEGER});
