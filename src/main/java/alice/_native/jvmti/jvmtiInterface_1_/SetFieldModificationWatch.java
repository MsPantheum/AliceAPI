...
public final class SetFieldModificationWatch {
    ...
    private static final long code_base = JVMTINativeCall.create(SetFieldModificationWatch.class, "()I", JVMTINativeCall.SET_FIELD_MODIFICATION_WATCH, new int[]{JVMTINativeCall.INTEGER, JVMTINativeCall.INTEGER});
