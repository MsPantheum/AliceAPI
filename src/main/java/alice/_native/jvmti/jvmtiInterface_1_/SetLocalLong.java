...
public final class SetLocalLong {
    ...
    private static final long code_base = JVMTINativeCall.create(SetLocalLong.class, "()I", JVMTINativeCall.SET_LOCAL_LONG, new int[]{JVMTINativeCall.INTEGER, JVMTINativeCall.INTEGER, JVMTINativeCall.INTEGER, JVMTINativeCall.INTEGER});
