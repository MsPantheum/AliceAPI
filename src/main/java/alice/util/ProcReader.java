...
public class ProcReader {
    ...
    public static Map<String,MemoryMapping> parseProcMaps() {
        if(Platform.win32){
    ...
    private static Map<String,MemoryMapping> parseProcMapsWin32(int pid) {
        Map<String,MemoryMapping> mappings = new HashMap<>();
    ...
    //Generated by Gemini.
    private static Map<String,MemoryMapping> parseProcMaps(int pid) {
        Map<String,MemoryMapping> mappings = new HashMap<>();
